...
################################################################################
# Prometheus Stack — Installation Functions
#
...
#
# Used for the 'kind' target. Kind is a bare Kubernetes cluster that ships
# without a monitoring stack or the PrometheusRule CRD — this step provides both.
#
...
install_prometheus() {
    ...
    if [[ -f "${rule_manifest}" ]]; then
        # Ensure the install namespace exists before applying the rule into it
